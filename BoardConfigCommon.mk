...
TARGET_KERNEL_ADDITIONAL_FLAGS := LLVM=1 AS=llvm-as CC=clang AR=llvm-ar NM=llvm-nm STRIP=llvm-strip OBJCOPY=llvm-objcopy OBJDUMP=llvm-objdump CLANG_TRIPLE=aarch64-linux-gnu-
TARGET_KERNEL_CROSS_COMPILE := $(TARGET_KERNEL_CLANG_PATH)/bin/clang
TARGET_KERNEL_CROSS_COMPILE_COMPAT := $(TARGET_KERNEL_CLANG_PATH)/bin/clang
TARGET_KERNEL_CROSS_COMPILE_ARM32 := $(TARGET_KERNEL_CLANG_PATH)/bin/clang
